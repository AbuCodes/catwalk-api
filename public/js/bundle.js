...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY2F0d2FsayIsImEiOiJjazF1YjA1c2YwenFyM2hrMW9sd2Jsd25tIn0.06pq1V0lvldA33OTxGTkSg';
...
var stripe = Stripe('pk_test_bJZ3p7QsMaNV6ssUr26k8Isl00I4qJQ3lb');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // 2) Create checkout form + proccess payment
